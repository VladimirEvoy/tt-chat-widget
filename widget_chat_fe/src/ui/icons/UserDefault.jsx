...
const UserDefault = () => {
    return (
        <svg viewBox="0 0 366.34 366.34">
            <defs>
                <linearGradient id="linear-gradient" x1="108.28" y1="122.42" x2="268.26" y2="122.42"
                                gradientUnits="userSpaceOnUse">
                    <stop offset="0" stopColor="#16243f"/>
                    <stop offset="1" stopColor="#6878b1"/>
                </linearGradient>
                <linearGradient id="linear-gradient-2" x1="219.28" y1="72.92" x2="269.19" y2="152.46"
            ...
            <path className="cls-2"
                  d="M214.63,246.85a16,16,0,0,1-10.07-1.56l-59.67-48.78c-.07-2.26-.13.11-.16-2.15q-.06-4.76-.1-9.51l2,1,5.2,2.69,2.41.41,27.88,4.74,31.12,5.3.94,32,.31,10.46.15,5.08v.33Z"/>
            ...
            <path className="cls-4"
                  d="M245.43,159.9a35.93,35.93,0,0,1-5.09,4.41a22.42,22.42,0,0,1-1.15-2.3c-2.64-6-4-12.51-5-19A275.93,275.93,0,0,1,231,114.49c-.91-15.34-7.46-22.95,5.57-34.91a43,43,0,0,1,16.35-9.38c.63.76,1.25,1.52,1.86,2.29C277.55,101.08,269.48,134.63,245.43,159.9Z"/>
            <circle className="cls-5" cx="134.98" cy="158.85" r="17"/>
            <circle className="cls-2" cx="140.38" cy="158.85" r="15.22"/>
            <path className="cls-1"
            ...
            <path className="cls-6" d="M191.51,185.15a29.78,29.78,0,0,0,18.54,9.69"/>
            <path className="cls-6" d="M215.13,137.94c-.08.35,13.36,36.13,13.36,36.13l-17.94.87"/>
            <path className="cls-6" d="M172.65,131a80.58,80.58,0,0,1,28.13-.8"/>
            <path className="cls-6" d="M231.7,131.13a55,55,0,0,1,17.45-1.21"/>
            ...
            <path className="cls-7" d="M186.28,142.24c6.1,0,6.1,9.38,0,9.43H186c-6.11,0-6.11-9.38,0-9.43h.27Z"/>
            <path className="cls-7" d="M236.41,140.85c5.66.05,5.66,8.7,0,8.75h-.26c-5.66,0-5.66-8.7,0-8.75h.26Z"/>
        </svg>
    );
};
